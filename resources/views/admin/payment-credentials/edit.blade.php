...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Editar Credencial de Pago</h1>
            ...
            <form action="{{ route('admin.payment-credentials.update', $paymentCredential) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <select name="payment_method_id" id="payment_method_id" required
                        ...
                        @foreach ($paymentMethods as $method)
                            <option value="{{ $method->id }}" @selected($method->id === $paymentCredential->payment_method_id)>
                                {{ $method->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $paymentCredential->nombre) }}" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="password" name="clave" id="clave" value="{{ old('clave', $paymentCredential->clave) }}" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="password" name="secreto" id="secreto" value="{{ old('secreto', $paymentCredential->secreto) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div id="datos-bancarios" style="display: none;" class="space-y-4 p-6 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div>
                        ...
                        <input type="text" name="banco" id="banco" value="{{ old('banco', $paymentCredential->banco ?? '') }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" name="cuenta" id="cuenta" value="{{ old('cuenta', $paymentCredential->cuenta ?? '') }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" name="cedula" id="cedula" value="{{ old('cedula', $paymentCredential->cedula ?? '') }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $paymentCredential->telefono ?? '') }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                               placeholder="Ej: +55 51 98129-6129">
                    </div>
                </div>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="activo" value="1" @checked(old('activo', $paymentCredential->activo))
